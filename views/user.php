            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="card card-user">
                            ...
                            <div class="content">
                                <div class="author">
                                  ...
                                  <h4 class="title"><?php 
                                  echo($_REQUEST['nom']); echo($_REQUEST['prenom']); 
                                  ?>
                                  <br />
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Edit Profile user</h4>
                            </div>
                            <div class="content">
                                <form>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>nom</label>
                                                <input type="text" name="nom" class="form-control border-input" placeholder="Company" value="Creative Code Inc.">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
